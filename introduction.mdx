...
<CardGroup cols={2}>
  ...
  <Card title="Training Pipeline" icon="diagram-project" href="/pipeline/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Explore the architecture" icon="book" href="/architecture/overview">
    Learn about the model architecture in detail
  </Card>
  <Card title="Train your own model" icon="graduation-cap" href="/pipeline/overview">
